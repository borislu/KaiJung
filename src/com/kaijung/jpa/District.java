...
@Views({
	@View(members=
	    "district [ name, status; memo; remark; modifyBy, modifyTime; createBy, createTime ]"
	)
})
@Tab(name="Latest", properties="oid, name, status, memo, remark, modifyBy, modifyTime", 
...
public class District implements Serializable {
	...
	@TableGenerator(
	    ...
	    pkColumnValue="district.oid", initialValue=1, allocationSize=1
	)
