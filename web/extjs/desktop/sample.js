...
MyDesktop.BogusModule = Ext.extend(Ext.app.Module, {
    ...
    createWindow020502: function(src){
        ...
        if (!win) {
            win = desktop.createWindow({
                ...
                width: 998,
                height: 480,
                html: '<iframe id="frameLayout" name="frameLayout" src="../../orderStore/senderLayout_U.html" frameborder="0" height="100%" scrolling="auto" width="100%"></iframe>',
                iconCls: 'bogus',
                shim: false,
                animCollapse: false,
                constrainHeader: true
    ...
    createWindow020602: function(src){
        ...
        if (!win) {
            win = desktop.createWindow({
                ...
                width: 998,
                height: 480,
                html: '<iframe id="frameLayout" name="frameLayout" src="../../orderStore/markLayout_R.html" frameborder="0" height="100%" scrolling="auto" width="100%"></iframe>',
                iconCls: 'bogus',
                shim: false,
                animCollapse: false,
                constrainHeader: true
    ...
    createWindow020702: function(src){
        ...
        if (!win) {
            win = desktop.createWindow({
                ...
                width: 998,
                height: 480,
                html: '<iframe id="frameLayout" name="frameLayout" src="../../orderStore/placeLayout_R.html" frameborder="0" height="100%" scrolling="auto" width="100%"></iframe>',
                iconCls: 'bogus',
                shim: false,
                animCollapse: false,
                constrainHeader: true
    ...
    createWindow020704: function(src){
        ...
        if (!win) {
            win = desktop.createWindow({
                ...
                width: 998,
                height: 480,
                html: '<iframe id="frameLayout" name="frameLayout" src="../../orderStore/placeLayout_S.html" frameborder="0" height="100%" scrolling="auto" width="100%"></iframe>',
                iconCls: 'bogus',
                shim: false,
                animCollapse: false,
                constrainHeader: true
    ...
    createWindow020705: function(src){
        ...
        if (!win) {
            win = desktop.createWindow({
                ...
                width: 998,
                height: 480,
                html: '<iframe id="frameLayout" name="frameLayout" src="../../orderStore/placeLayout_U.html" frameborder="0" height="100%" scrolling="auto" width="100%"></iframe>',
                iconCls: 'bogus',
                shim: false,
                animCollapse: false,
                constrainHeader: true
    ...
    createWindow050101: function(src){
        var desktop = this.app.getDesktop();
        var win = desktop.getWindow('bogus' + src.windowId);
        if (!win) {
            win = desktop.createWindow({
                ...
                width: 998,
                height: 480,
                html: '<iframe id="frameLayout" name="frameLayout" src="../../item/itemLayout.html" frameborder="0" height="100%" scrolling="auto" width="100%"></iframe>',
                iconCls: 'bogus',
                shim: false,
                animCollapse: false,
                constrainHeader: true
    ...
    createWindow050102: function(src){
        var desktop = this.app.getDesktop();
        var win = desktop.getWindow('bogus' + src.windowId);
        if (!win) {
            win = desktop.createWindow({
    ...
    createWindow050103: function(src){
        var desktop = this.app.getDesktop();
        var win = desktop.getWindow('bogus' + src.windowId);
        if (!win) {
            win = desktop.createWindow({
    ...
    createWindow050104: function(src){
        var desktop = this.app.getDesktop();
        var win = desktop.getWindow('bogus' + src.windowId);
        if (!win) {
            win = desktop.createWindow({
    ...
    createWindow050105: function(src){
        var desktop = this.app.getDesktop();
        var win = desktop.getWindow('bogus' + src.windowId);
        if (!win) {
            win = desktop.createWindow({
                ...
                items: [{
                    ...
                    menu: { 
                          items: [{
                              text: '新增',
                              iconCls: 'bogus',
                              handler: this.createWindow050101,
                              scope: this,
                              windowId: '050101'
                                   }, {
                              text: '查詢',
                              iconCls: 'bogus',
                              handler: this.createWindow050102,
                              scope: this,
                              windowId: '050102'
                                   }, {
                              text: '瀏覽',
                              iconCls: 'bogus',
                              handler: this.createWindow050103,
                              scope: this,
                              windowId: '050103'
                                   }, {
                              text: '修改',
                              iconCls: 'bogus',
                              handler: this.createWindow050104,
                              scope: this,
                              windowId: '050104'
                                   }, {
                              text: '刪除',
                              iconCls: 'bogus',
                              handler: this.createWindow050105,
                              scope: this,
                              windowId: '050105'
                                   }]
                           }
