...
<% } %>
	...
	<script type='text/javascript' src='<%=request.getContextPath()%>/js/ox_ext_brandList.js'></script>
  ...
  function changeLink(){  
    if( ($('a')==null) || ($('a').length < 1) ){
      ...
      //alert(parent.frames['frameWest']); //.contentDocument
      ...
      $("a[href^='javascript:openxava.executeAction(\'KaiJung\', \'BrandListOnly\', \'\', false, \'List.viewDetail\'']").each(function() {
        index = $(this).attr('href').substring(96);
        this.href="javascript:parent.frames['frameWest'].openxava.executeAction('KaiJung', 'BrandDetailOnly', '', false, 'List.viewDetail', 'row="+ index }
				   	);
    }
  }
  changeLink();
