...
<% } %>
	...
	%> 	
	<script type='text/javascript' src='<%=request.getContextPath()%>/xava/style/liferay51/js/theme_display.js'></script>	
	<script type='text/javascript' src='<%=request.getContextPath()%>/xava/style/liferay51/js/barebone_unpacked.js'></script>	
	<script type='text/javascript' src='<%=request.getContextPath()%>/xava/style/liferay51/js/liferay_init.js'></script>	
