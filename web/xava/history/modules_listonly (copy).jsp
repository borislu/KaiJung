...
<% } %>
  ...
  function changeLink(){  
    if( ($('a')==null) || ($('a').length < 1) ){
      ...
      //alert( $("a[href^='javascript:openxava.executeAction(\'KaiJung\', \'OrderStoreListOnly\', \'\', false, \'List.viewDetail\'']") );
      //alert( 'a: '+ $("a[href^='javascript:openxava.executeAction(\'KaiJung\', \'OrderStoreListOnly\', \'\', false, \'List.viewDetail\'']").length );
$("a[href^='javascript:openxava.executeAction(\'KaiJung\', \'OrderStoreListOnly\', \'\', false, \'List.viewDetail\'']").each(function(index) {
      this.href="javascript:parent.frames['frameWest'].openxava.executeAction('KaiJung', 'OrderStoreListOnly', '', false, 'List.viewDetail', 'row="+ index +"')" }
					);
    }
  }
  changeLink();
