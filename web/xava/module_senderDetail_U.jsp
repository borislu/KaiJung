...
<script type='text/javascript' src='../dwr/interface/OrderSenderDwr.js'></script>
<script type='text/javascript' src='../orderStore/senderDetail.js'></script>
<script type='text/javascript' src='../orderStore/senderDetail_U.js'></script>
<% if (!isPortlet) { %>
</head>
<body bgcolor="#ffffff">
