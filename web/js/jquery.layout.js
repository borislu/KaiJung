 ...
 */
	...
	,	defaults: { // default options for 'all panes' - will be overridden by 'per-pane settings'
		...
		,	sliderTip:			"開啟隱藏頁" // resizer-bar triggers 'sliding' when pane is closed
		,	sliderCursor:			"pointer"	// cursor when resizer-bar will trigger 'sliding'
		,	slideTrigger_open:		"click"		// click, dblclick, mouseover
		,	slideTrigger_close:		"mouseout"	// click, mouseout
		,	hideTogglerOnSlide:		false		// when pane is slid-open, should the toggler show?
		,	togglerContent_open:	        "內容隱藏"			// text or HTML to put INSIDE the toggler
		,	togglerContent_closed:	        "內容開啟"			// ditto
 ...
 */
	...
	var setPaneMinMaxSizes = function (pane) {
		...
		,	limitSize	= containerSize - paneSpacing  // Boris 改成 panel 可以重疊
  //,	maxSize		= Math.min(s.maxSize || 9999, limitSize)
		,	maxSize		= Math.min(9999, limitSize)
		,	minSize		= s.minSize || 0
 ...
 */
    ...
    //	if (o.applyDefaultStyles)
				$R.css(c.resizers.cssDef); // Layout 的分隔線，用來控制 Layout 的大小
