...
alert('markDetail.js: oid_txt: '+ oid_txt);
        ...
        $(this).find('td').slice(3, 8).each(//訂單的尺寸數量(惟讀)
            function(i){
...
//alert( 'markDetail.js: markId: ' + $('input[name="ox_KaiJung_OrderMarkDetailOnly__oid"]').eq(1).val() );
    ...
    OrderMarkDwr.getImportByMark ( markId, function(orderD_Set){ // argument: wareId , return: orderD_Set
//alert( 'markDetail.js: length: '+ orderD_Set.length + ' markId: ' + markId );
