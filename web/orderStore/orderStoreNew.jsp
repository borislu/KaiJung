   ...
   <table id="mainTable" align="center" border="1" bordercolor="#cccccc" cellpadding="0" cellspacing="0" width="765">
       <tbody> 
        ...
        <tr method="post" name="row1" id="row1">
            ...
            <td>
                <div align="center">
                 <input name="barcode" id="barcode1" size="13" maxlength="15" onChange="getByBarcode(this);" type="text"/>
                </div>
            </td>
            <td>
             <div align="center">
              <input name="articleno" id="articleno1" size="10" maxlength="13" onChange="getByArticleno(this);" type="text"/>
             </div>
            </td>
            <td>
             <div align="center">
            ...
            <td>
                <div align="center">
                 <input name="color" id="color1" size="3" maxlength="3" type="text" />
                </div>
            </td>
            <td>
